...
const PARTNERS: Partner[] = [
  ...
  { name: 'Гармония',          url: 'https://2gis.kz/almaty/geo/9429940000928950/76.973941,43.216807',      color: '#5BBF3A', bg: '#EFF9E8', letter: 'Г',  logo: '/images/sadiks/garmoniya.png'   },
  { name: 'Солнечные лучи',    url: 'https://2gis.kz/almaty/geo/9429940001308947/76.969255,43.252131',      color: '#F59E0B', bg: '#FEF3C7', letter: 'С'                                          },
  { name: 'Ордоген',           url: 'https://2gis.kz/almaty/geo/70000001056446663/77.021807,43.291633',     color: '#3B82F6', bg: '#EFF6FF', letter: 'О',  logo: '/images/sadiks/ordogen.png'    },
  { name: 'Султанкурган',      url: 'https://2gis.kz/almaty/geo/9429940000800824/76.927058,43.316355',      color: '#8B5CF6', bg: '#F3EFFE', letter: 'С',  logo: '/images/sadiks/sultankurgan.png'},
  { name: 'Вдохновение',       url: 'https://2gis.kz/almaty/geo/70000001034423627/76.952503,43.347403',     color: '#EC4899', bg: '#FDF2F8', letter: 'В',  logo: '/images/sadiks/vdohnovenie.png' },
  { name: 'Солнечные зайки',   url: 'https://2gis.kz/almaty/geo/70000001037283188',                         color: '#F97316', bg: '#FFF0E6', letter: 'С',  logo: '/images/sadiks/sol-zayki.png'   },
  { name: 'Мади Kids',         url: 'https://2gis.kz/almaty/geo/70000001043831325/76.981011,43.252276',     color: '#14B8A6', bg: '#F0FDFA', letter: 'М',  logo: '/images/sadiks/madi-kids.png'   },
  { name: 'Римон',             url: 'https://2gis.kz/almaty/geo/70000001031499970',                         color: '#6366F1', bg: '#EEF2FF', letter: 'Р',  logo: '/images/sadiks/rimon.png'       },
  { name: 'Сания',             url: 'https://2gis.kz/almaty/geo/70000001089006317/76.799492,43.237209',     color: '#5BBF3A', bg: '#EFF9E8', letter: 'С',  logo: '/images/sadiks/saniya.png'      },
  { name: 'Сания',             url: 'https://2gis.kz/almaty/geo/70000001023174402/76.789244,43.240576',     color: '#D84040', bg: '#FEECEC', letter: 'С',  logo: '/images/sadiks/saniya.png'      },
  { name: 'Сания',             url: 'https://2gis.kz/almaty/geo/70000001033941325/76.785360,43.243263',     color: '#F59E0B', bg: '#FEF3C7', letter: 'С',  logo: '/images/sadiks/saniya.png'      },
];
